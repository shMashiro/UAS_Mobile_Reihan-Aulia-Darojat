...
import 'package:todo_app/view/end_drawer.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Todo List', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
        leading: IconButton(
      ...
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            final todoList = snapshot.data!.docs.map((e) => Todo.fromMap(e)).toList();
                            ...
                            InkWell(
                              onTap: () {
                                todoController.updateTodo(
                                    todo.id, todo.copyWith(isDone: !todo.isDone));
                              },
                              child: Container(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (todo != null) {
                todoController.updateTodo(
                    todo.id, todo.copyWith(text: textController.text, time: time));
              } else {
                todoController.addTodo(
                    textController.text, time, getDateTimestamp(DateTime.now()));
              }
              Navigator.pop(context);
            },
